...
input_text="Hi this is doctor Om kotawala, autoplay testing!"
...
def text_to_speech_with_elevenlabs(input_text, output_filepath):
    ...
    if not shutil.which("ffmpeg"):
        raise EnvironmentError("ffmpeg is not available. Please install ffmpeg and ensure it is in your PATH.")
