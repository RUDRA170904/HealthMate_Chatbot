...
def process_inputs(audio_filepath, image_filepath):
    ...
    print(f"Image file path: {image_filepath}")

    # Ensure the audio file exists
    if not os.path.exists(audio_filepath):
        return "Audio file not found", "No response"
    ...
    # Skip text-to-speech conversion
...
iface.launch(debug=True, share=True, inbrowser=True)
